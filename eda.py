...
Outputs:
    reports/figures/   — PNG plots (300 DPI, PDF-ready)
    reports/tables/    — CSV summary tables
    reports/eda_report.md — Narrative content + figure references for PDF
"""
...
*Generated by `eda.py` — insert figures from `reports/figures/` when compiling PDF.*
"""
...
def run_eda() -> None:
    ...
    print("=" * 60)
    print("\nTo use in PDF: open reports/eda_report.md and insert figures from reports/figures/")
